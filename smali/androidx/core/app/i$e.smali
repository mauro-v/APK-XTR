...
.method private e(III)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/core/app/i$e;->f(Landroidx/core/graphics/drawable/IconCompat;II)Landroid/graphics/Bitmap;
...
.method private g(IIII)Landroid/graphics/Bitmap;
    ...
    sget v0, Ld/g/c;->notification_icon_background:I
    ...
    :cond_0
    invoke-direct {p0, v0, p4, p2}, Landroidx/core/app/i$e;->e(III)Landroid/graphics/Bitmap;
...
.method public c(ZIZ)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p2}, Landroidx/core/app/i$d;->f()I
    ...
    sget p2, Ld/g/d;->notification_background:I

    sget v4, Ld/g/c;->notification_bg_low:I

    invoke-virtual {v7, p2, v2, v4}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V

    sget p2, Ld/g/d;->icon:I

    sget v4, Ld/g/c;->notification_template_icon_low_bg:I
    ...
    sget v4, Ld/g/c;->notification_bg:I

    invoke-virtual {v7, p2, v2, v4}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V

    sget p2, Ld/g/d;->icon:I

    sget v4, Ld/g/c;->notification_template_icon_bg:I
    ...
    iget-object v2, p2, Landroidx/core/app/i$d;->i:Landroid/graphics/Bitmap;
    ...
    iget-object v2, v2, Landroidx/core/app/i$d;->i:Landroid/graphics/Bitmap;
    ...
    iget-object p1, p1, Landroidx/core/app/i$d;->Q:Landroid/app/Notification;

    iget p1, p1, Landroid/app/Notification;->icon:I

    if-eqz p1, :cond_7

    sget p1, Ld/g/b;->notification_right_icon_size:I

    invoke-virtual {v0, p1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p1

    sget p2, Ld/g/b;->notification_small_icon_background_padding:I
    ...
    iget-object v2, v1, Landroidx/core/app/i$d;->Q:Landroid/app/Notification;

    iget v2, v2, Landroid/app/Notification;->icon:I

    invoke-virtual {v1}, Landroidx/core/app/i$d;->d()I

    move-result v1

    invoke-direct {p0, v2, p1, p2, v1}, Landroidx/core/app/i$e;->g(IIII)Landroid/graphics/Bitmap;

    move-result-object p1

    sget p2, Ld/g/d;->right_icon:I
    ...
    :cond_4
    sget p1, Ld/g/d;->right_icon:I

    iget-object p2, p0, Landroidx/core/app/i$e;->a:Landroidx/core/app/i$d;

    iget-object p2, p2, Landroidx/core/app/i$d;->Q:Landroid/app/Notification;

    iget p2, p2, Landroid/app/Notification;->icon:I

    invoke-virtual {p0, p2, v1}, Landroidx/core/app/i$e;->d(II)Landroid/graphics/Bitmap;
    ...
    iget-object p1, p2, Landroidx/core/app/i$d;->Q:Landroid/app/Notification;

    iget p1, p1, Landroid/app/Notification;->icon:I

    if-eqz p1, :cond_7

    sget p1, Ld/g/d;->icon:I
    ...
    sget p1, Ld/g/b;->notification_large_icon_width:I

    invoke-virtual {v0, p1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p1

    sget p2, Ld/g/b;->notification_big_circle_margin:I
    ...
    sget p2, Ld/g/b;->notification_small_icon_size_as_large:I
    ...
    iget-object p1, p1, Landroidx/core/app/i$d;->d:Ljava/lang/CharSequence;

    if-eqz p1, :cond_8

    sget p2, Ld/g/d;->title:I
    ...
    iget-object p2, p2, Landroidx/core/app/i$d;->i:Landroid/graphics/Bitmap;
    ...
    iget-object v2, v1, Landroidx/core/app/i$d;->j:Ljava/lang/CharSequence;

    if-eqz v2, :cond_b

    sget p1, Ld/g/d;->info:I
    ...
    :cond_b
    iget v1, v1, Landroidx/core/app/i$d;->k:I

    if-lez v1, :cond_d

    sget p1, Ld/g/e;->status_bar_notification_info_maxnum:I
    ...
    iget p2, p2, Landroidx/core/app/i$d;->k:I

    if-le p2, p1, :cond_c

    sget p1, Ld/g/d;->info:I

    sget p2, Ld/g/f;->status_bar_notification_info_overflow:I
    ...
    iget-object v1, v1, Landroidx/core/app/i$d;->q:Ljava/lang/CharSequence;
    ...
    sget v2, Ld/g/d;->text:I

    invoke-virtual {v7, v2, v1}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/app/i$e;->a:Landroidx/core/app/i$d;

    iget-object v1, v1, Landroidx/core/app/i$d;->e:Ljava/lang/CharSequence;

    if-eqz v1, :cond_e

    sget v2, Ld/g/d;->text2:I

    invoke-virtual {v7, v2, v1}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V

    sget v1, Ld/g/d;->text2:I
    ...
    sget p3, Ld/g/b;->notification_subtext_size:I
    ...
    invoke-virtual {p3}, Landroidx/core/app/i$d;->g()J
    ...
    iget-boolean p2, p2, Landroidx/core/app/i$d;->n:Z
...
.method public d(II)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroidx/core/app/i$e;->e(III)Landroid/graphics/Bitmap;
...
.method public k(Landroidx/core/app/i$d;)V
    .locals 1
    ...
    invoke-virtual {p1, p0}, Landroidx/core/app/i$d;->w(Landroidx/core/app/i$e;)Landroidx/core/app/i$d;
