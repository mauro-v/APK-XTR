...
.field final e:Landroidx/mediarouter/media/c$b$d;
...
.method public constructor <init>(Landroidx/mediarouter/media/MediaRouteProviderService;Landroid/os/Messenger;I)V
    ...
    iput-object p1, p0, Landroidx/mediarouter/media/MediaRouteProviderService$b;->e:Landroidx/mediarouter/media/c$b$d;
...
.method public a(Ljava/lang/String;I)Landroid/os/Bundle;
    ...
    iget-object v0, v0, Landroidx/mediarouter/media/MediaRouteProviderService;->j:Landroidx/mediarouter/media/c;

    invoke-virtual {v0, p1}, Landroidx/mediarouter/media/c;->s(Ljava/lang/String;)Landroidx/mediarouter/media/c$b;
    ...
    iget-object v2, p0, Landroidx/mediarouter/media/MediaRouteProviderService$b;->e:Landroidx/mediarouter/media/c$b$d;

    invoke-virtual {v0, v1, v2}, Landroidx/mediarouter/media/c$b;->q(Ljava/util/concurrent/Executor;Landroidx/mediarouter/media/c$b$d;)V
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/c$b;->k()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/c$b;->l()Ljava/lang/String;
...
.method public b(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    iget-object p2, p2, Landroidx/mediarouter/media/MediaRouteProviderService;->j:Landroidx/mediarouter/media/c;

    invoke-virtual {p2, p1}, Landroidx/mediarouter/media/c;->t(Ljava/lang/String;)Landroidx/mediarouter/media/c$e;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/mediarouter/media/c;->u(Ljava/lang/String;Ljava/lang/String;)Landroidx/mediarouter/media/c$e;
...
.method public c()V
    ...
    check-cast v3, Landroidx/mediarouter/media/c$e;

    invoke-virtual {v3}, Landroidx/mediarouter/media/c$e;->e()V
    ...
    invoke-virtual {p0, v0}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->i(Landroidx/mediarouter/media/b;)Z

    return-void
.end method

.method public d(I)Landroidx/mediarouter/media/c$e;
    .locals 1
...
.method public e(Landroid/os/Messenger;)Z
    .locals 1
...
.method public g(I)Z
    ...
    check-cast v0, Landroidx/mediarouter/media/c$e;
...
.method h(Landroidx/mediarouter/media/c$b;Ljava/util/Collection;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/c$b$c;->g()Landroid/os/Bundle;
...
.method public i(Landroidx/mediarouter/media/b;)Z
    .locals 1
    ...
    invoke-virtual {p1}, Landroidx/mediarouter/media/MediaRouteProviderService;->y()Z
