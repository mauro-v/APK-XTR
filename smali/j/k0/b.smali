...
.field public static final c:Lj/h0;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private static final d:Lk/s;
...
.field private static final f:Li/d0/f;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lj/k0/b;->a:[B

    sget-object v1, Lj/x;->f:Lj/x$b;

    new-array v2, v0, [Ljava/lang/String;

    invoke-virtual {v1, v2}, Lj/x$b;->g([Ljava/lang/String;)Lj/x;

    move-result-object v1

    sput-object v1, Lj/k0/b;->b:Lj/x;

    sget-object v1, Lj/h0;->f:Lj/h0$b;

    sget-object v2, Lj/k0/b;->a:[B

    const/4 v3, 0x0

    const/4 v4, 0x1

    invoke-static {v1, v2, v3, v4, v3}, Lj/h0$b;->d(Lj/h0$b;[BLj/a0;ILjava/lang/Object;)Lj/h0;

    move-result-object v1

    sput-object v1, Lj/k0/b;->c:Lj/h0;

    sget-object v5, Lj/f0;->a:Lj/f0$a;

    sget-object v6, Lj/k0/b;->a:[B
    ...
    invoke-static/range {v5 .. v11}, Lj/f0$a;->f(Lj/f0$a;[BLj/a0;IIILjava/lang/Object;)Lj/f0;

    sget-object v1, Lk/s;->h:Lk/s$a;

    const/4 v2, 0x5

    new-array v2, v2, [Lk/h;

    sget-object v5, Lk/h;->i:Lk/h$a;

    const-string v6, "efbbbf"

    invoke-virtual {v5, v6}, Lk/h$a;->b(Ljava/lang/String;)Lk/h;
    ...
    invoke-virtual {v0, v5}, Lk/h$a;->b(Ljava/lang/String;)Lk/h;
    ...
    invoke-virtual {v0, v4}, Lk/h$a;->b(Ljava/lang/String;)Lk/h;
    ...
    invoke-virtual {v1, v2}, Lk/s$a;->d([Lk/h;)Lk/s;

    move-result-object v0

    sput-object v0, Lj/k0/b;->d:Lk/s;
    ...
    sput-object v0, Lj/k0/b;->e:Ljava/util/TimeZone;
    ...
    sput-object v0, Lj/k0/b;->f:Li/d0/f;
    ...
    invoke-static {v0, v1}, Li/d0/g;->e0(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "Client"

    invoke-static {v0, v1}, Li/d0/g;->f0(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lj/k0/b;->h:Ljava/lang/String;
...
.method public static final C(Ljava/net/Socket;Lk/g;)Z
    .locals 2
...
.method public static final E(Lk/g;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    .locals 1
    .param p0    # Lk/g;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    sget-object v0, Lj/k0/b;->d:Lk/s;

    invoke-interface {p0, v0}, Lk/g;->r0(Lk/s;)I
    ...
    sget-object p0, Li/d0/d;->d:Li/d0/d;

    invoke-virtual {p0}, Li/d0/d;->b()Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p0}, Li/d0/d;->a()Ljava/nio/charset/Charset;
    ...
    :goto_0
    invoke-static {p1, p0}, Li/y/c/h;->b(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static final F(Lk/g;)I
    .locals 3
    .param p0    # Lk/g;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {v2, v1}, Lj/k0/b;->b(BI)I
    ...
    invoke-static {p0, v1}, Lj/k0/b;->b(BI)I
...
.method public static final G(Lk/e;B)I
    .locals 3
    .param p0    # Lk/e;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final H(Lk/b0;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .param p0    # Lk/b0;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {p0}, Lk/b0;->timeout()Lk/c0;

    move-result-object v2

    invoke-virtual {v2}, Lk/c0;->e()Z
    ...
    invoke-virtual {v2, p1, p2}, Lk/c0;->d(J)Lk/c0;
    ...
    invoke-interface {p0, p1, v7, v8}, Lk/b0;->g0(Lk/e;J)J
    ...
    invoke-virtual {p0}, Lk/c0;->a()Lk/c0;
    ...
    invoke-virtual {p0, v0, v1}, Lk/c0;->d(J)Lk/c0;
...
.method public static final I(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    new-instance v0, Lj/k0/b$b;

    invoke-direct {v0, p0, p1}, Lj/k0/b$b;-><init>(Ljava/lang/String;Z)V

    return-object v0
.end method

.method public static final J(Lj/x;)Ljava/util/List;
    .locals 5
    .param p0    # Lj/x;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {v1, v0}, Li/a0/d;->i(II)Li/a0/c;
    ...
    check-cast v2, Li/t/y;

    invoke-virtual {v2}, Li/t/y;->b()I
    ...
    invoke-direct {v3, v4, v2}, Lj/k0/i/c;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static final K(Ljava/util/List;)Lj/x;
    .locals 3
    ...
    check-cast v1, Lj/k0/i/c;

    invoke-virtual {v1}, Lj/k0/i/c;->a()Lk/h;

    move-result-object v2

    invoke-virtual {v1}, Lj/k0/i/c;->b()Lk/h;

    move-result-object v1

    invoke-virtual {v2}, Lk/h;->I()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, v1}, Lj/x$a;->c(Ljava/lang/String;Ljava/lang/String;)Lj/x$a;
...
.method public static final L(Lj/y;Z)Ljava/lang/String;
    .locals 5
    .param p0    # Lj/y;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p0}, Lj/y;->n()I

    move-result p1

    sget-object v1, Lj/y;->l:Lj/y$b;

    invoke-virtual {p0}, Lj/y;->r()Ljava/lang/String;
...
.method public static synthetic M(Lj/y;ZILjava/lang/Object;)Ljava/lang/String;
    .locals 0
    ...
    :cond_0
    invoke-static {p0, p1}, Lj/k0/b;->L(Lj/y;Z)Ljava/lang/String;
...
.method public static final N(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0}, Li/t/j;->F(Ljava/util/Collection;)Ljava/util/List;
...
.method public static final R(Ljava/lang/String;II)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Lj/k0/b;->w(Ljava/lang/String;II)I

    move-result p1

    invoke-static {p0, p1, p2}, Lj/k0/b;->y(Ljava/lang/String;II)I
...
.method public static synthetic S(Ljava/lang/String;IIILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Lj/k0/b;->R(Ljava/lang/String;II)Ljava/lang/String;
...
.method public static final U(Lk/f;I)V
    .locals 1
    .param p0    # Lk/f;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final e(Lj/u;)Lj/u$b;
    .locals 1
    .param p0    # Lj/u;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    new-instance v0, Lj/k0/b$a;

    invoke-direct {v0, p0}, Lj/k0/b$a;-><init>(Lj/u;)V
...
.method public static final f(Ljava/lang/String;)Z
    ...
    sget-object v0, Lj/k0/b;->f:Li/d0/f;
...
.method public static final g(Lj/y;Lj/y;)Z
    .locals 2
    .param p0    # Lj/y;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p0, p1}, Li/y/c/h;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public static final n(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p1, v0, v1, v2, v3}, Li/d0/g;->E(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
...
.method public static synthetic o(Ljava/lang/String;CIIILjava/lang/Object;)I
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lj/k0/b;->m(Ljava/lang/String;CII)I
...
.method public static final p(Lk/b0;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    .param p0    # Lk/b0;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lj/k0/b;->H(Lk/b0;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final s(Lj/g0;)J
    .locals 2
    .param p0    # Lj/g0;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p0}, Lj/g0;->S()Lj/x;

    move-result-object p0

    const-string v0, "Content-Length"

    invoke-virtual {p0, v0}, Lj/x;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lj/k0/b;->P(Ljava/lang/String;J)J
