...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->B()I
...
.method private A(Landroidx/appcompat/view/menu/d$d;Landroidx/appcompat/view/menu/g;)Landroid/view/View;
    ...
    invoke-direct {p0, v0, p2}, Landroidx/appcompat/view/menu/d;->z(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/g;)Landroid/view/MenuItem;
...
.method private B()I
    ...
    invoke-static {v0}, Ld/g/q/u;->C(Landroid/view/View;)I
...
.method private D(Landroidx/appcompat/view/menu/g;)V
    ...
    invoke-static {p1}, Landroidx/appcompat/view/menu/k;->v(Landroidx/appcompat/view/menu/g;)Z
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->x()Landroidx/appcompat/widget/h0;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/f0;->n(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/f0;->D(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->r:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/f0;->E(I)V
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/h0;->S(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/h0;->P(Ljava/lang/Object;)V

    invoke-direct {p0, v2}, Landroidx/appcompat/view/menu/d;->C(I)I
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/f0;->B(Landroid/view/View;)V
    ...
    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/f0;->K(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/f0;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/f0;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/f0;->F(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v4}, Landroidx/appcompat/widget/f0;->h()Landroid/widget/ListView;
...
.method private x()Landroidx/appcompat/widget/h0;
    .locals 5
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/h0;->R(Landroidx/appcompat/widget/g0;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/f0;->J(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/f0;->I(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->s:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/f0;->B(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/f0;->H(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/f0;->G(I)V

    return-object v0
.end method

.method private y(Landroidx/appcompat/view/menu/g;)I
    .locals 3
...
.method private z(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/g;)Landroid/view/MenuItem;
    .locals 4
...
.method public a(Landroidx/appcompat/view/menu/g;Z)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/view/menu/d;->y(Landroidx/appcompat/view/menu/g;)I
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/h0;->Q(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/h0;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/f0;->C(I)V
...
.method public b(Z)V
    ...
    invoke-static {v0}, Landroidx/appcompat/view/menu/k;->w(Landroid/widget/ListAdapter;)Landroidx/appcompat/view/menu/f;
