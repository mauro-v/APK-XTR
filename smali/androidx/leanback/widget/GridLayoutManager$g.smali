...
.method constructor <init>(Landroidx/leanback/widget/GridLayoutManager;IZ)V
    ...
    iput-object p1, p0, Landroidx/leanback/widget/GridLayoutManager$g;->u:Landroidx/leanback/widget/GridLayoutManager;

    invoke-direct {p0, p1}, Landroidx/leanback/widget/GridLayoutManager$d;-><init>(Landroidx/leanback/widget/GridLayoutManager;)V

    iput p2, p0, Landroidx/leanback/widget/GridLayoutManager$g;->t:I

    iput-boolean p3, p0, Landroidx/leanback/widget/GridLayoutManager$g;->s:Z
...
.method protected C(Landroidx/recyclerview/widget/RecyclerView$y$a;)V
    ...
    iget v0, p0, Landroidx/leanback/widget/GridLayoutManager$g;->t:I
    ...
    :cond_0
    invoke-super {p0, p1}, Landroidx/recyclerview/widget/g;->C(Landroidx/recyclerview/widget/RecyclerView$y$a;)V
...
.method protected D()V
    ...
    invoke-super {p0}, Landroidx/leanback/widget/GridLayoutManager$d;->D()V

    const/4 v0, 0x0

    iput v0, p0, Landroidx/leanback/widget/GridLayoutManager$g;->t:I
    ...
    iget-object v1, p0, Landroidx/leanback/widget/GridLayoutManager$g;->u:Landroidx/leanback/widget/GridLayoutManager;

    const/4 v2, 0x1

    invoke-virtual {v1, v0, v2}, Landroidx/leanback/widget/GridLayoutManager;->B3(Landroid/view/View;Z)V
...
.method E()V
    ...
    iget-boolean v0, p0, Landroidx/leanback/widget/GridLayoutManager$g;->s:Z
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/leanback/widget/GridLayoutManager;->r3(ZI)I
    ...
    iget-object v0, p0, Landroidx/leanback/widget/GridLayoutManager$g;->u:Landroidx/leanback/widget/GridLayoutManager;

    invoke-virtual {v0}, Landroidx/leanback/widget/GridLayoutManager;->W2()Z
    ...
    invoke-virtual {v0}, Landroidx/leanback/widget/GridLayoutManager;->V2()Z
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView$y;->p(I)V
...
.method F()V
    ...
    :cond_2
    iget-object v3, p0, Landroidx/leanback/widget/GridLayoutManager$g;->u:Landroidx/leanback/widget/GridLayoutManager;

    invoke-virtual {v3, v0}, Landroidx/leanback/widget/GridLayoutManager;->S1(Landroid/view/View;)Z
    ...
    iget v1, p0, Landroidx/leanback/widget/GridLayoutManager$g;->t:I
    ...
    :goto_3
    iput v1, p0, Landroidx/leanback/widget/GridLayoutManager$g;->t:I
...
.method public a(I)Landroid/graphics/PointF;
    ...
    iget p1, p0, Landroidx/leanback/widget/GridLayoutManager$g;->t:I
