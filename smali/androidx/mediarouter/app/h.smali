...
.field final g:Landroidx/mediarouter/media/g;

.field private final h:Landroidx/mediarouter/app/h$g;

.field private i:Landroidx/mediarouter/media/f;

.field j:Landroidx/mediarouter/media/g$f;
...
.field x:Landroidx/mediarouter/media/g$f;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/h;->i:Landroidx/mediarouter/media/f;
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/h;->g:Landroidx/mediarouter/media/g;
    ...
    iget-object p1, p0, Landroidx/mediarouter/app/h;->g:Landroidx/mediarouter/media/g;

    invoke-virtual {p1}, Landroidx/mediarouter/media/g;->j()Landroidx/mediarouter/media/g$f;

    move-result-object p1

    iput-object p1, p0, Landroidx/mediarouter/app/h;->j:Landroidx/mediarouter/media/g$f;
    ...
    invoke-virtual {p1}, Landroidx/mediarouter/media/g;->h()Landroid/support/v4/media/session/MediaSessionCompat$Token;

    move-result-object p1

    invoke-direct {p0, p1}, Landroidx/mediarouter/app/h;->o(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
...
.method private o(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-virtual {p0}, Landroidx/mediarouter/app/h;->t()V
...
.method private r()Z
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/h;->x:Landroidx/mediarouter/media/g$f;
...
.method g()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/h;->j:Landroidx/mediarouter/media/g$f;

    invoke-virtual {v1}, Landroidx/mediarouter/media/g$f;->h()Landroidx/mediarouter/media/g$f$a;
    ...
    invoke-virtual {v1}, Landroidx/mediarouter/media/g$f;->q()Landroidx/mediarouter/media/g$e;

    move-result-object v1

    invoke-virtual {v1}, Landroidx/mediarouter/media/g$e;->f()Ljava/util/List;
    ...
    invoke-virtual {v2}, Landroidx/mediarouter/media/g$f;->h()Landroidx/mediarouter/media/g$f$a;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3}, Landroidx/mediarouter/media/g$f$a;->b()Z
...
.method public i(Landroidx/mediarouter/media/g$f;)Z
    .locals 1

    invoke-virtual {p1}, Landroidx/mediarouter/media/g$f;->w()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p1}, Landroidx/mediarouter/media/g$f;->x()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/mediarouter/app/h;->i:Landroidx/mediarouter/media/f;
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/h;->j:Landroidx/mediarouter/media/g$f;
...
.method public l(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/mediarouter/app/h;->i(Landroidx/mediarouter/media/g$f;)Z
...
.method m()V
    ...
    invoke-static {v3, v1}, Ld/g/p/c;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public onAttachedToWindow()V
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/h;->g:Landroidx/mediarouter/media/g;

    iget-object v2, p0, Landroidx/mediarouter/app/h;->i:Landroidx/mediarouter/media/f;

    iget-object v3, p0, Landroidx/mediarouter/app/h;->h:Landroidx/mediarouter/app/h$g;

    invoke-virtual {v1, v2, v3, v0}, Landroidx/mediarouter/media/g;->b(Landroidx/mediarouter/media/f;Landroidx/mediarouter/media/g$a;I)V

    invoke-virtual {p0}, Landroidx/mediarouter/app/h;->u()V

    iget-object v0, p0, Landroidx/mediarouter/app/h;->g:Landroidx/mediarouter/media/g;

    invoke-virtual {v0}, Landroidx/mediarouter/media/g;->h()Landroid/support/v4/media/session/MediaSessionCompat$Token;

    move-result-object v0

    invoke-direct {p0, v0}, Landroidx/mediarouter/app/h;->o(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    sget p1, Ld/m/i;->mr_cast_dialog:I
    ...
    sget p1, Ld/m/f;->mr_cast_close_button:I
    ...
    sget p1, Ld/m/f;->mr_cast_stop_button:I
    ...
    sget p1, Ld/m/f;->mr_cast_meta_background:I
    ...
    sget p1, Ld/m/f;->mr_cast_meta_black_scrim:I
    ...
    sget p1, Ld/m/f;->mr_cast_meta_art:I
    ...
    sget p1, Ld/m/f;->mr_cast_meta_title:I
    ...
    sget p1, Ld/m/f;->mr_cast_meta_subtitle:I
    ...
    sget v0, Ld/m/j;->mr_cast_dialog_title_view_placeholder:I
    ...
    invoke-virtual {p0}, Landroidx/mediarouter/app/h;->s()V
...
.method public onDetachedFromWindow()V
    ...
    invoke-direct {p0, v1}, Landroidx/mediarouter/app/h;->o(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V

    return-void
.end method

.method public p(Landroidx/mediarouter/media/f;)V
    .locals 3
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroidx/mediarouter/media/g;->b(Landroidx/mediarouter/media/f;Landroidx/mediarouter/media/g$a;I)V
...
.method s()V
    ...
    invoke-virtual {p0}, Landroidx/mediarouter/app/h;->v()V
...
.method t()V
    ...
    invoke-direct {p0}, Landroidx/mediarouter/app/h;->r()Z
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/h;->j:Landroidx/mediarouter/media/g$f;

    invoke-virtual {v2}, Landroidx/mediarouter/media/g$f;->C()Z
    ...
    invoke-virtual {v2}, Landroidx/mediarouter/media/g$f;->w()Z
...
.method u()V
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/g$f;->q()Landroidx/mediarouter/media/g$e;

    move-result-object v0

    invoke-virtual {v0}, Landroidx/mediarouter/media/g$e;->f()Ljava/util/List;
    ...
    :cond_1
    invoke-virtual {v2}, Landroidx/mediarouter/media/g$f$a;->b()Z
    ...
    :cond_2
    invoke-virtual {v2}, Landroidx/mediarouter/media/g$f$a;->c()Z
    ...
    invoke-virtual {p0, v0}, Landroidx/mediarouter/app/h;->l(Ljava/util/List;)V
...
.method v()V
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/g$f;->C()Z
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/g$f;->w()Z
