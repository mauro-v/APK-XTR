...
.field j:Landroidx/mediarouter/media/c;

.field private k:Landroidx/mediarouter/media/b;
...
.method static a(Landroidx/mediarouter/media/d;I)Landroid/os/Bundle;
    ...
    invoke-virtual {v1, v0}, Landroidx/mediarouter/media/d$a;->c(Ljava/util/Collection;)Landroidx/mediarouter/media/d$a;
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/media/a;->o()I

    move-result v2

    if-lt p1, v2, :cond_1

    invoke-virtual {v0}, Landroidx/mediarouter/media/a;->n()I
    ...
    :cond_2
    invoke-virtual {v1}, Landroidx/mediarouter/media/d$a;->b()Landroidx/mediarouter/media/d;
...
.method private c(Landroid/os/Messenger;)Landroidx/mediarouter/media/MediaRouteProviderService$b;
    ...
    invoke-virtual {p0, p1}, Landroidx/mediarouter/media/MediaRouteProviderService;->b(Landroid/os/Messenger;)I
...
.method static v(Landroid/os/Messenger;I)V
    .locals 6
    ...
    invoke-static/range {v0 .. v5}, Landroidx/mediarouter/media/MediaRouteProviderService;->x(Landroid/os/Messenger;IIILjava/lang/Object;Landroid/os/Bundle;)V

    :cond_0
    return-void
.end method

.method private static w(Landroid/os/Messenger;I)V
    .locals 6
...
.method static x(Landroid/os/Messenger;IIILjava/lang/Object;Landroid/os/Bundle;)V
    .locals 1
...
.method b(Landroid/os/Messenger;)I
    ...
    invoke-virtual {v2, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->e(Landroid/os/Messenger;)Z
...
.method e(Landroid/os/Messenger;IILjava/lang/String;)Z
    .locals 3
    ...
    invoke-virtual {v0, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->d(I)Landroidx/mediarouter/media/c$e;

    move-result-object v1

    instance-of v2, v1, Landroidx/mediarouter/media/c$b;

    if-eqz v2, :cond_1

    check-cast v1, Landroidx/mediarouter/media/c$b;

    invoke-virtual {v1, p4}, Landroidx/mediarouter/media/c$b;->n(Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {p1, p2}, Landroidx/mediarouter/media/MediaRouteProviderService;->w(Landroid/os/Messenger;I)V
...
.method f(Landroid/os/Messenger;)V
    ...
    :cond_0
    invoke-virtual {p1}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->c()V

    :cond_1
    return-void
.end method

.method g(Landroid/os/Messenger;IILjava/lang/String;)Z
    .locals 7
    ...
    invoke-static/range {v1 .. v6}, Landroidx/mediarouter/media/MediaRouteProviderService;->x(Landroid/os/Messenger;IIILjava/lang/Object;Landroid/os/Bundle;)V
...
.method public abstract h()Landroidx/mediarouter/media/c;
.end method

.method i(Landroid/os/Messenger;IILjava/lang/String;Ljava/lang/String;)Z
    .locals 2
    ...
    invoke-virtual {v0, p4, p5, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->b(Ljava/lang/String;Ljava/lang/String;I)Z
...
.method j(Landroid/os/Messenger;II)Z
    ...
    invoke-virtual {v1}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->f()Z
    ...
    iget-object p3, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->j:Landroidx/mediarouter/media/c;

    invoke-virtual {p3}, Landroidx/mediarouter/media/c;->o()Landroidx/mediarouter/media/d;
    ...
    invoke-static/range {v2 .. v7}, Landroidx/mediarouter/media/MediaRouteProviderService;->x(Landroid/os/Messenger;IIILjava/lang/Object;Landroid/os/Bundle;)V
...
.method k(Landroid/os/Messenger;II)Z
    .locals 2
    ...
    invoke-virtual {v0, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->g(I)Z
...
.method l(Landroid/os/Messenger;IILjava/lang/String;)Z
    .locals 3
    ...
    invoke-virtual {v1, p4}, Landroidx/mediarouter/media/c$b;->o(Ljava/lang/String;)V
...
.method m(Landroid/os/Messenger;IILandroid/content/Intent;)Z
    .locals 10
    ...
    invoke-virtual {v7, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->d(I)Landroidx/mediarouter/media/c$e;
    ...
    :cond_0
    invoke-virtual {v8, p4, v0}, Landroidx/mediarouter/media/c$e;->d(Landroid/content/Intent;Landroidx/mediarouter/media/g$c;)Z
...
.method n(Landroid/os/Messenger;II)Z
    .locals 2
...
.method o(Landroid/os/Messenger;ILandroidx/mediarouter/media/b;)Z
    .locals 3
    ...
    invoke-virtual {v0, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->i(Landroidx/mediarouter/media/b;)Z
    ...
    iget-object p3, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->k:Landroidx/mediarouter/media/b;
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object p1, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->j:Landroidx/mediarouter/media/c;

    if-nez p1, :cond_1

    invoke-virtual {p0}, Landroidx/mediarouter/media/MediaRouteProviderService;->h()Landroidx/mediarouter/media/c;
    ...
    iput-object p1, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->j:Landroidx/mediarouter/media/c;
...
.method public onUnbind(Landroid/content/Intent;)Z
    ...
    iget-object v0, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->j:Landroidx/mediarouter/media/c;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroidx/mediarouter/media/c;->w(Landroidx/mediarouter/media/c$a;)V
...
.method p(Landroid/os/Messenger;III)Z
    ...
    invoke-virtual {v1, p4}, Landroidx/mediarouter/media/c$e;->g(I)V
...
.method q(Landroid/os/Messenger;I)Z
    .locals 3
    ...
    :cond_0
    invoke-virtual {v0}, Landroidx/mediarouter/media/MediaRouteProviderService$b;->c()V
...
.method r(Landroid/os/Messenger;III)Z
    .locals 2
    ...
    invoke-virtual {v1, p4}, Landroidx/mediarouter/media/c$e;->i(I)V
...
.method s(Landroid/os/Messenger;IILjava/util/List;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1, p4}, Landroidx/mediarouter/media/c$b;->p(Ljava/util/List;)V
...
.method t(Landroid/os/Messenger;III)Z
    .locals 2
    ...
    invoke-virtual {v1, p4}, Landroidx/mediarouter/media/c$e;->j(I)V
...
.method u(Landroidx/mediarouter/media/d;)V
    .locals 9
    ...
    invoke-static/range {v3 .. v8}, Landroidx/mediarouter/media/MediaRouteProviderService;->x(Landroid/os/Messenger;IIILjava/lang/Object;Landroid/os/Bundle;)V
...
.method y()Z
    ...
    invoke-virtual {v6}, Landroidx/mediarouter/media/b;->d()Landroidx/mediarouter/media/f;

    move-result-object v7

    invoke-virtual {v7}, Landroidx/mediarouter/media/f;->f()Z

    move-result v7

    if-eqz v7, :cond_0

    invoke-virtual {v6}, Landroidx/mediarouter/media/b;->e()Z
    ...
    invoke-virtual {v3}, Landroidx/mediarouter/media/b;->d()Landroidx/mediarouter/media/f;
    ...
    invoke-virtual {v1, v6}, Landroidx/mediarouter/media/f$a;->c(Landroidx/mediarouter/media/f;)Landroidx/mediarouter/media/f$a;
    ...
    invoke-virtual {v1}, Landroidx/mediarouter/media/f$a;->d()Landroidx/mediarouter/media/f;
    ...
    :cond_5
    iget-object v0, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->k:Landroidx/mediarouter/media/b;

    invoke-static {v0, v3}, Ld/g/p/c;->a(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    if-nez v0, :cond_6

    iput-object v3, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->k:Landroidx/mediarouter/media/b;

    iget-object v0, p0, Landroidx/mediarouter/media/MediaRouteProviderService;->j:Landroidx/mediarouter/media/c;

    invoke-virtual {v0, v3}, Landroidx/mediarouter/media/c;->y(Landroidx/mediarouter/media/b;)V
