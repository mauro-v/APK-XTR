...
.method public bridge synthetic g(Ld/p/a/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/n/r$a;->i(Ld/p/a/f;Landroidx/work/impl/n/p;)V

    return-void
.end method

.method public i(Ld/p/a/f;Landroidx/work/impl/n/p;)V
    .locals 10
    ...
    :goto_0
    iget-object v0, p2, Landroidx/work/impl/n/p;->b:Landroidx/work/s;

    invoke-static {v0}, Landroidx/work/impl/n/v;->h(Landroidx/work/s;)I
    ...
    invoke-interface {p1, v1, v2, v3}, Ld/p/a/d;->bindLong(IJ)V
    ...
    :cond_3
    invoke-interface {p1, v1, v0}, Ld/p/a/d;->bindBlob(I[B)V
    ...
    invoke-static {v8}, Landroidx/work/impl/n/v;->g(Landroidx/work/l;)I

    move-result v8

    int-to-long v8, v8

    invoke-interface {p1, v6, v8, v9}, Ld/p/a/d;->bindLong(IJ)V
    ...
    invoke-interface {p1, v5, v8, v9}, Ld/p/a/d;->bindLong(IJ)V
    ...
    invoke-interface {p1, v4, v5, v6}, Ld/p/a/d;->bindLong(IJ)V
    ...
    invoke-interface {p1, v3, v4, v5}, Ld/p/a/d;->bindLong(IJ)V
    ...
    invoke-interface {p1, v2, v3, v4}, Ld/p/a/d;->bindLong(IJ)V
    ...
    :cond_5
    invoke-interface {p1, v7, p2}, Ld/p/a/d;->bindBlob(I[B)V

    goto :goto_6

    :cond_6
    invoke-interface {p1, v6}, Ld/p/a/d;->bindNull(I)V

    invoke-interface {p1, v5}, Ld/p/a/d;->bindNull(I)V

    invoke-interface {p1, v4}, Ld/p/a/d;->bindNull(I)V

    invoke-interface {p1, v3}, Ld/p/a/d;->bindNull(I)V

    invoke-interface {p1, v2}, Ld/p/a/d;->bindNull(I)V
    ...
    :goto_5
    invoke-interface {p1, v7}, Ld/p/a/d;->bindNull(I)V
