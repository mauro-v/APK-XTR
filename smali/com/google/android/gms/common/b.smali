...
.method public static k()Lcom/google/android/gms/common/b;
    .locals 1
...
.method static n(Landroid/content/Context;ILcom/google/android/gms/common/internal/g;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
...
.method static o(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-static {p1, p3}, Lcom/google/android/gms/common/h;->H1(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lcom/google/android/gms/common/h;

    move-result-object p1

    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/h;->G1(Landroidx/fragment/app/h;Ljava/lang/String;)V
...
.method private final q(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/b;->p(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v4}, Landroidx/core/app/i$d;->q(Z)Landroidx/core/app/i$d;

    invoke-virtual {v3, v4}, Landroidx/core/app/i$d;->j(Z)Landroidx/core/app/i$d;

    invoke-virtual {v3, p3}, Landroidx/core/app/i$d;->n(Ljava/lang/CharSequence;)Landroidx/core/app/i$d;

    new-instance p3, Landroidx/core/app/i$b;

    invoke-direct {p3}, Landroidx/core/app/i$b;-><init>()V

    invoke-virtual {p3, v0}, Landroidx/core/app/i$b;->l(Ljava/lang/CharSequence;)Landroidx/core/app/i$b;

    invoke-virtual {v3, p3}, Landroidx/core/app/i$d;->w(Landroidx/core/app/i$e;)Landroidx/core/app/i$d;
    ...
    invoke-static {p3}, Lcom/google/android/gms/common/internal/q;->j(Z)V
    ...
    invoke-virtual {v3, p3}, Landroidx/core/app/i$d;->v(I)Landroidx/core/app/i$d;

    invoke-virtual {v3, v5}, Landroidx/core/app/i$d;->s(I)Landroidx/core/app/i$d;
    ...
    sget p3, Le/c/a/b/a/a;->common_full_open_on_phone:I

    sget v0, Le/c/a/b/a/b;->common_open_on_phone:I
    ...
    :cond_3
    invoke-virtual {v3, p4}, Landroidx/core/app/i$d;->l(Landroid/app/PendingIntent;)Landroidx/core/app/i$d;
    ...
    sget p3, Le/c/a/b/a/b;->common_google_play_services_notification_ticker:I

    invoke-virtual {v1, p3}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p3

    invoke-virtual {v3, p3}, Landroidx/core/app/i$d;->x(Ljava/lang/CharSequence;)Landroidx/core/app/i$d;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7}, Landroidx/core/app/i$d;->z(J)Landroidx/core/app/i$d;

    invoke-virtual {v3, p4}, Landroidx/core/app/i$d;->l(Landroid/app/PendingIntent;)Landroidx/core/app/i$d;

    invoke-virtual {v3, v0}, Landroidx/core/app/i$d;->m(Ljava/lang/CharSequence;)Landroidx/core/app/i$d;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/b;->s()Ljava/lang/String;
    ...
    :cond_6
    :goto_2
    invoke-virtual {v3, p3}, Landroidx/core/app/i$d;->k(Ljava/lang/String;)Landroidx/core/app/i$d;
    ...
    sget-object p3, Lcom/google/android/gms/common/e;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private final s()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/android/gms/common/b;->b:Ljava/lang/String;
...
.method public final d(I)Ljava/lang/String;
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/c;->d(I)Ljava/lang/String;
...
.method public e(Landroid/content/Context;)I
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/c;->e(Landroid/content/Context;)I
...
.method public f(Landroid/content/Context;I)I
    ...
    invoke-super {p0, p1, p2}, Lcom/google/android/gms/common/c;->f(Landroid/content/Context;I)I
...
.method public final g(I)Z
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/c;->g(I)Z
...
.method public i(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p2, p3, p4}, Lcom/google/android/gms/common/b;->n(Landroid/content/Context;ILcom/google/android/gms/common/internal/g;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public j(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/ConnectionResult;->t0()Z
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/google/android/gms/common/ConnectionResult;->S()I

    move-result p2

    const/4 v0, 0x0

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/gms/common/b;->b(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public l(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/gms/common/b;->i(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p2, p3, p4}, Lcom/google/android/gms/common/b;->o(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public m(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/google/android/gms/common/c;->c(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;

    move-result-object v0

    const/4 v1, 0x0

    invoke-direct {p0, p1, p2, v1, v0}, Lcom/google/android/gms/common/b;->q(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
...
.method public final r(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/android/gms/common/b;->j(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, p1, p2, v1, p3}, Lcom/google/android/gms/common/b;->q(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
