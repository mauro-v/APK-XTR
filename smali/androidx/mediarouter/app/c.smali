...
.field P:Landroidx/mediarouter/media/g$f;
...
.field final h:Landroidx/mediarouter/media/g;
...
.field final j:Landroidx/mediarouter/media/g$f;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-static {p2}, Landroidx/mediarouter/media/g;->g(Landroid/content/Context;)Landroidx/mediarouter/media/g;

    move-result-object p2

    iput-object p2, p0, Landroidx/mediarouter/app/c;->h:Landroidx/mediarouter/media/g;
    ...
    iget-object p2, p0, Landroidx/mediarouter/app/c;->h:Landroidx/mediarouter/media/g;

    invoke-virtual {p2}, Landroidx/mediarouter/media/g;->j()Landroidx/mediarouter/media/g$f;

    move-result-object p2

    iput-object p2, p0, Landroidx/mediarouter/app/c;->j:Landroidx/mediarouter/media/g$f;

    iget-object p2, p0, Landroidx/mediarouter/app/c;->h:Landroidx/mediarouter/media/g;

    invoke-virtual {p2}, Landroidx/mediarouter/media/g;->h()Landroid/support/v4/media/session/MediaSessionCompat$Token;

    move-result-object p2

    invoke-direct {p0, p2}, Landroidx/mediarouter/app/c;->E(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    sget v0, Ld/m/d;->mr_controller_volume_group_list_padding_top:I
    ...
    sget p2, Ld/m/h;->mr_linear_out_slow_in:I
    ...
    sget p2, Ld/m/h;->mr_fast_out_slow_in:I
...
.method private C(Z)V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/c;->j:Landroidx/mediarouter/media/g$f;
...
.method private N()V
    ...
    iget-object v5, p0, Landroidx/mediarouter/app/c;->j:Landroidx/mediarouter/media/g$f;

    invoke-virtual {v5}, Landroidx/mediarouter/media/g$f;->p()I
    ...
    sget v1, Ld/m/j;->mr_controller_casting_screen:I
    ...
    sget v1, Ld/m/j;->mr_controller_no_info_available:I
    ...
    sget v1, Ld/m/j;->mr_controller_no_media_selected:I
    ...
    sget v0, Ld/m/a;->mediaRoutePauseDrawable:I

    sget v2, Ld/m/j;->mr_controller_pause:I
    ...
    sget v0, Ld/m/a;->mediaRouteStopDrawable:I

    sget v2, Ld/m/j;->mr_controller_stop:I
    ...
    sget v0, Ld/m/a;->mediaRoutePlayDrawable:I

    sget v2, Ld/m/j;->mr_controller_play:I
...
.method private O()V
    ...
    invoke-virtual {p0, v0}, Landroidx/mediarouter/app/c;->z(Landroidx/mediarouter/media/g$f;)Z
    ...
    iget-object v3, p0, Landroidx/mediarouter/app/c;->j:Landroidx/mediarouter/media/g$f;

    invoke-virtual {v3}, Landroidx/mediarouter/media/g$f;->u()I
    ...
    invoke-virtual {v3}, Landroidx/mediarouter/media/g$f;->s()I
...
.method private i(Landroid/view/View;I)V
    ...
    invoke-static {p1}, Landroidx/mediarouter/app/c;->s(Landroid/view/View;)I
...
.method private o()V
    ...
    check-cast v5, Landroidx/mediarouter/media/g$f;
...
.method private v()Z
    ...
    invoke-static {v3, v1}, Landroidx/mediarouter/app/c;->Q(Landroid/net/Uri;Landroid/net/Uri;)Z
...
.method H(Z)V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/c;->P:Landroidx/mediarouter/media/g$f;
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/c;->j:Landroidx/mediarouter/media/g$f;

    invoke-virtual {v1}, Landroidx/mediarouter/media/g$f;->C()Z
    ...
    invoke-virtual {v1}, Landroidx/mediarouter/media/g$f;->w()Z
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/c;->j:Landroidx/mediarouter/media/g$f;

    invoke-virtual {v2}, Landroidx/mediarouter/media/g$f;->m()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Landroidx/mediarouter/media/g$f;->a()Z
    ...
    invoke-static {v0}, Landroidx/mediarouter/app/c;->u(Landroid/graphics/Bitmap;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/mediarouter/app/c;->K(Z)V
...
.method I()V
    ...
    invoke-direct {p0}, Landroidx/mediarouter/app/c;->v()Z
...
.method J()V
    ...
    sget v1, Ld/m/d;->mr_controller_volume_group_list_item_icon_size:I
    ...
    sget v1, Ld/m/d;->mr_controller_volume_group_list_item_height:I
    ...
    sget v1, Ld/m/d;->mr_controller_volume_group_list_max_height:I
...
.method L(Z)V
    ...
    invoke-static {v0}, Landroidx/mediarouter/app/c;->s(Landroid/view/View;)I
    ...
    invoke-direct {p0, v1}, Landroidx/mediarouter/app/c;->M(Z)V
    ...
    invoke-virtual {p0, v2, v4}, Landroidx/mediarouter/app/c;->r(II)I
    ...
    invoke-direct {p0, v0}, Landroidx/mediarouter/app/c;->t(Z)I
    ...
    invoke-virtual {v5}, Landroidx/mediarouter/media/g$f;->y()Z
    ...
    iget-object v6, p0, Landroidx/mediarouter/app/c;->j:Landroidx/mediarouter/media/g$f;

    invoke-virtual {v6}, Landroidx/mediarouter/media/g$f;->l()Ljava/util/List;
    ...
    invoke-static {v1}, Landroidx/mediarouter/app/c;->s(Landroid/view/View;)I
    ...
    :goto_6
    invoke-direct {p0, v0}, Landroidx/mediarouter/app/c;->M(Z)V
    ...
    :cond_9
    invoke-direct {p0, v3}, Landroidx/mediarouter/app/c;->t(Z)I
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/c;->w:Landroid/widget/FrameLayout;
    ...
    invoke-direct {p0, p1}, Landroidx/mediarouter/app/c;->C(Z)V
...
.method P(Landroid/view/View;)V
    ...
    sget v0, Ld/m/f;->volume_item_container:I
    ...
    sget v0, Ld/m/f;->mr_volume_item_icon:I
...
.method h(Ljava/util/Map;Ljava/util/Map;)V
    ...
    check-cast v9, Landroidx/mediarouter/media/g$f;
    ...
    invoke-direct {v4, v0, v5}, Landroidx/mediarouter/app/c$a;-><init>(Landroidx/mediarouter/app/c;Landroidx/mediarouter/media/g$f;)V
...
.method m(Z)V
    ...
    :cond_0
    sget v4, Ld/m/f;->volume_item_container:I
...
.method public onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/c;->h:Landroidx/mediarouter/media/g;
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroidx/mediarouter/media/g;->b(Landroidx/mediarouter/media/f;Landroidx/mediarouter/media/g$a;I)V

    iget-object v0, p0, Landroidx/mediarouter/app/c;->h:Landroidx/mediarouter/media/g;

    invoke-virtual {v0}, Landroidx/mediarouter/media/g;->h()Landroid/support/v4/media/session/MediaSessionCompat$Token;

    move-result-object v0

    invoke-direct {p0, v0}, Landroidx/mediarouter/app/c;->E(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    sget v0, Ld/m/i;->mr_controller_material_dialog_b:I
    ...
    sget v2, Ld/m/f;->mr_expandable_area:I
    ...
    sget v2, Ld/m/f;->mr_dialog_area:I
    ...
    sget v4, Ld/m/j;->mr_controller_disconnect:I
    ...
    sget v4, Ld/m/j;->mr_controller_stop_casting:I
    ...
    sget v2, Ld/m/f;->mr_custom_control:I
    ...
    sget v2, Ld/m/f;->mr_default_control:I
    ...
    sget v3, Ld/m/f;->mr_control_title_container:I
    ...
    sget v2, Ld/m/f;->mr_media_main_control:I
    ...
    sget v2, Ld/m/f;->mr_control_divider:I
    ...
    sget v2, Ld/m/f;->mr_playback_control:I
    ...
    sget v2, Ld/m/f;->mr_control_title:I
    ...
    sget v2, Ld/m/f;->mr_control_subtitle:I
    ...
    sget v2, Ld/m/f;->mr_control_playback_ctrl:I
    ...
    sget v0, Ld/m/f;->mr_volume_control:I
    ...
    sget v0, Ld/m/f;->mr_volume_slider:I
    ...
    sget v0, Ld/m/f;->mr_volume_group_list:I
    ...
    sget v0, Ld/m/f;->mr_group_expand_collapse:I
    ...
    sget v1, Ld/m/g;->mr_controller_volume_group_list_animation_duration_ms:I
    ...
    sget v1, Ld/m/g;->mr_controller_volume_group_list_fade_in_duration_ms:I
    ...
    sget v1, Ld/m/g;->mr_controller_volume_group_list_fade_out_duration_ms:I
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :cond_1
    :goto_0
    iget-object p2, p0, Landroidx/mediarouter/app/c;->j:Landroidx/mediarouter/media/g$f;
    ...
    :goto_1
    invoke-virtual {p2, p1}, Landroidx/mediarouter/media/g$f;->H(I)V
...
.method z(Landroidx/mediarouter/media/g$f;)Z
    .locals 2
