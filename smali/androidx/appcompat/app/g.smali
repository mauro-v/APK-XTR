...
.field private static final e:Ld/d/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ld/d/i<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/g;->d:[Ljava/lang/String;

    new-instance v0, Ld/d/i;

    invoke-direct {v0}, Ld/d/i;-><init>()V

    sput-object v0, Landroidx/appcompat/app/g;->e:Ld/d/i;
...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Ld/g/q/u;->P(Landroid/view/View;)Z
...
.method private r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, Landroidx/appcompat/app/g;->e:Ld/d/i;

    invoke-virtual {v0, p2}, Ld/d/i;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object p1, Landroidx/appcompat/app/g;->e:Ld/d/i;

    invoke-virtual {p1, p2, v0}, Ld/d/i;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private s(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :goto_0
    sget-object v3, Landroidx/appcompat/app/g;->d:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v3}, Landroidx/appcompat/app/g;->r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v1}, Landroidx/appcompat/app/g;->r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
...
.method final q(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, Landroidx/appcompat/app/g;->t(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/app/g;->p(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/x;
    ...
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->b(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/c;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/q;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/l;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/j;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/e;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/g;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;

    move-result-object p5

    :goto_2
    invoke-direct {p0, p5, p2}, Landroidx/appcompat/app/g;->u(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, p4}, Landroidx/appcompat/app/g;->s(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {p0, p5, p4}, Landroidx/appcompat/app/g;->a(Landroid/view/View;Landroid/util/AttributeSet;)V
